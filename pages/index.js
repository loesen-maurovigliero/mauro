        ...
        <div>
          ...
          <main className="border-style: solid">
            ...
            <div className='p-4 bg-white text-800 flex'>
              ...
              <div>Developer <strong> Full-stack </strong> </div>
            </div>
            <div className='p-4 bg-white text-800 flex'>
            ...
            <div className='p-4 bg-white text-800 flex'>
              ...
              <div className="flex flex-wrap">
                <span className='p-1 bg-800 text-white m-2'>Html - css - javascript</span>
                <span className='p-1 bg-800 text-white m-2'>Mongodb - mysql</span>
                <span className='p-1 bg-800 text-white m-2'>Bootstrap - React - Vue</span>            
              </div>
            </div>
            <div className='p-4 bg-white text-800 flex'>
              ...
              <div> 
              {social.map( data => {
                <data.icon alt={`Contacto a la red social ${ data.name }`} href={ data.href } />
              })}
              </div>
            </div>
          </main>
